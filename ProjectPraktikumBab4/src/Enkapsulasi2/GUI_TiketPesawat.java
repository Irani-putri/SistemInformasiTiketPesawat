...
public class GUI_TiketPesawat extends javax.swing.JFrame {
    ...
    String hargaTiketStr = txtHarga.getText();

    // Validasi input
    if (kodeTiket.isEmpty() || namaPenumpang.isEmpty() || tujuan.isEmpty() ||
        tanggalKeberangkatan.isEmpty() || hargaTiketStr.isEmpty()) {
        memoTiket.setText("⚠️ Semua kolom harus diisi!");
        return;
    }

    try {
        // Konversi harga
        double harga = Double.parseDouble(hargaTiketStr);

        // Membuat objek TiketPesawat (menggunakan enkapsulasi)
        ...
        // Tampilkan data ke JTextArea
        memoTiket.setText("=== INFORMASI TIKET PESAWAT ===\n");
        memoTiket.append(tiket.getInfoTiket());

    } catch (NumberFormatException e) {
        memoTiket.setText("⚠️ Harga tiket harus berupa angka valid.");
    }
