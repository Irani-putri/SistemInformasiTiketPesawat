...
public class GUI_Tiket extends javax.swing.JFrame {
    ...
    private void btnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSimpanActionPerformed
      try {
        ...
        // Buat objek berdasarkan tipe tiket
        TiketPesawat tiket = null;
        String jenisTiket = "";

        if (radiobtnEkonomi.isSelected()) {
            tiket = new TiketEkonomi(kode, nama, tujuan, tanggal, harga, true);
            jenisTiket = "Ekonomi";
        } else if (radiobtnBisnis.isSelected()) {
            tiket = new TiketBisnis(kode, nama, tujuan, tanggal, harga, fasilitas);
            jenisTiket = "Bisnis";
        }
        ...
        Object[] data = {
            tiket.getKodeTiket(),
            jenisTiket,
            tiket.getNamaPenumpang(),
            tiket.getTujuan(),
            tiket.getTanggalKeberangkatan(),
            tiket.getHarga(),
            (tiket instanceof TiketBisnis) ? ((TiketBisnis) tiket).getFasilitasTambahan() : "-"
        };
        ...
        if (harga == 0) {
            JOptionPane.showMessageDialog(this, "Harga Tiket Tidak Boleh 0 !!", "Warning", JOptionPane.WARNING_MESSAGE);
            return;
        }

        // Jika semua valid, tampilkan hasil atau simpan data
        JOptionPane.showMessageDialog(this, "Data Berhasil Disimpan!");
        
        // Tambahkan proses simpan atau logika lain di sini...

    } catch (NumberFormatException e) {
        // Menampilkan pesan error jika harga bukan angka
        JOptionPane.showMessageDialog(this, "Harga Tiket Harus Berupa Angka!", "Warning", JOptionPane.WARNING_MESSAGE);
